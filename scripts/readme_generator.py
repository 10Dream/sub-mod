...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🌀 **ترکیب تمام منابع (میکس)** | [📝 دریافت لینک]({base_raw_url}/normal/mix.txt) | [🔒 دریافت لینک]({base_raw_url}/base64/mix.txt) | [🧊 دریافت لینک]({base_raw_url}/clash/mix.yaml) | [♾️ دریافت لینک]({base_raw_url}/clash/mix_unlimited.yaml) | **{get_relative_time('sub/normal/mix.txt')}** |
"""
    ...
    for f in normal_files:
        ...
        clash_filename = f"{base_name}.yaml"
        clash_unlimited_filename = f"{base_name}_unlimited.yaml"
        
        has_b64 = os.path.exists(f"sub/base64/{f}")
        has_clash = os.path.exists(f"sub/clash/{clash_filename}")
        has_clash_unlimited = os.path.exists(f"sub/clash/{clash_unlimited_filename}")
        ...
        clash_unlimited_link = f"[♾️ دریافت لینک]({base_raw_url}/clash/{clash_unlimited_filename})" if has_clash_unlimited else "❌ ندارد"
        
        markdown += f"| 📄 **{f}** | {normal_link} | {b64_link} | {clash_link} | {clash_unlimited_link} | {get_relative_time(filepath_normal)} |\n"
...
"""
    ...
    for proto in protocols_order:
        ...
        clash_unlimited_filename = f"{proto}_unlimited.yaml"
        ...
        has_clash_unlimited = os.path.exists(f"sub/clash/split/protocols/{clash_unlimited_filename}")
        ...
        clash_unlimited_link = f"[♾️ دریافت لینک]({base_raw_url}/clash/split/protocols/{clash_unlimited_filename})" if has_clash_unlimited else "❌ ندارد"
        
        markdown += f"| 🔌 **{proto.upper()}** | {normal_link} | {b64_link} | {clash_link} | {clash_unlimited_link} | {get_relative_time(filepath_proto)} |\n"
...
"""
    ...
    for f in split_files:
        ...
        clash_filename = f"{base_n}.yaml"
        clash_unlimited_filename = f"{base_n}_unlimited.yaml"
        
        has_b64 = os.path.exists(f"sub/base64/split/{f}")
        has_clash = os.path.exists(f"sub/clash/split/{clash_filename}")
        has_clash_unlimited = os.path.exists(f"sub/clash/split/{clash_unlimited_filename}")
        ...
        clash_unlimited_link = f"[♾️ دریافت لینک]({base_raw_url}/clash/split/{clash_unlimited_filename})" if has_clash_unlimited else "❌ ندارد"
        
        markdown += f"| ⚙️ **{base_n.upper()}** | {normal_link} | {b64_link} | {clash_link} | {clash_unlimited_link} | {get_relative_time(filepath_split)} |\n"
...
"""
    ...
    for f in datacenter_files:
        ...
        clash_unlimited_filename = f"{raw_name}_unlimited.yaml"
        ...
        has_clash_unlimited = os.path.exists(f"sub/clash/split/datacenters/{clash_unlimited_filename}")
        ...
        clash_unlimited_link = f"[♾️ دریافت لینک]({base_raw_url}/clash/split/datacenters/{clash_unlimited_filename})" if has_clash_unlimited else "❌ ندارد"
        
        markdown += f"| 🏢 **{display_name}** | {normal_link} | {b64_link} | {clash_link} | {clash_unlimited_link} | {get_relative_time(filepath_dc)} |\n"
...
"""
    ...
    for f in country_files:
        ...
        clash_unlimited_filename = f"{cc}_unlimited.yaml"
        
        has_b64 = os.path.exists(f"sub/base64/split/countries/{f}")
        has_clash = os.path.exists(f"sub/clash/split/countries/{clash_filename}")
        has_clash_unlimited = os.path.exists(f"sub/clash/split/countries/{clash_unlimited_filename}")
        ...
        clash_unlimited_link = f"[♾️ دریافت لینک]({base_raw_url}/clash/split/countries/{clash_unlimited_filename})" if has_clash_unlimited else "❌ ندارد"
        
        markdown += f"| {flag_img} **{cc}** | {normal_link} | {b64_link} | {clash_link} | {clash_unlimited_link} | {get_relative_time(filepath_country)} |\n"
